...
## Purpose
`sandbox/` is a scratch space for quick experiments, manual tests, and throwaway notebooks. Nothing here ships with the library or its documentation builds.
...
- Store large datasets or generated artifacts outside the repository; only commit lightweight assets needed to explain an experiment.
