...
- Integration evidence:
  ...
  - `tests/physipy/test_convert_physipy.py` and `tests/quantities/test_convert_quantities.py` (new optional-backend integration hardening for `physipy` and `quantities`).
